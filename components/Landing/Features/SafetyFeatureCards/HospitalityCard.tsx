        ...
        <div className="w-full max-w-[1140px] h-[360px] bg-[#003A5C] rounded-3xl p-10 shadow-lg border border-neutral-900 flex flex-col relative overflow-hidden mx-auto">
            ...
            <div className="absolute -bottom-2 -right-4 w-[280px] h-[220px]">
                <svg width="302" height="276" viewBox="0 0 302 276" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M63.3295 61.4027C64.8295 59.6866 67.3931 59.4977 69.0538 60.9489C70.7145 62.4002 70.8707 64.966 69.3711 66.6824C67.8712 68.3987 65.307 68.5882 63.6462 67.1368C61.9854 65.6854 61.8296 63.119 63.3295 61.4027Z" stroke="white" />
                    <path d="M116.368 85.7658C118.538 83.2821 122.253 83.0017 124.663 85.1073C127.072 87.2129 127.292 90.9317 125.121 93.4155C122.951 95.8989 119.237 96.1788 116.827 94.0733C114.418 91.9677 114.198 88.2495 116.368 85.7658Z" stroke="white" />
                    ...
                    <path d="M169.741 29.0473L169.741 38.1943L163.236 34.2938L163.243 25.8765L169.741 29.0473Z" stroke="white" />
                    <path d="M181.89 35.5473L181.889 44.6943L175.384 40.7938L175.392 32.3765L181.89 35.5473Z" stroke="white" />
                    <path d="M169.741 29.0473L169.741 38.1943L163.236 34.2938L163.243 25.8765L169.741 29.0473Z" stroke="white" />
                    <path d="M194.89 42.5473L194.889 51.6943L188.384 47.7938L188.392 39.3765L194.89 42.5473Z" stroke="white" />
                    <path d="M206.89 49.5473L206.889 58.6943L200.384 54.7938L200.392 46.3765L206.89 49.5473Z" stroke="white" />
                    <path d="M182.038 54.0473L182.038 63.1943L175.533 59.2938L175.54 50.8765L182.038 54.0473Z" stroke="white" />
                    <path d="M169.89 47.5473L169.889 56.6943L163.384 52.7938L163.392 44.3765L169.89 47.5473Z" stroke="white" />
                    <path d="M195.038 61.0473L195.038 70.1943L188.533 66.2938L188.54 57.8765L195.038 61.0473Z" stroke="white" />
